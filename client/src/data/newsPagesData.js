export const newsPageItems = [
  {
    id: 'news-page-01',
    title: 'Xorazm Iqtisodiyot Universiteti tez kunda o‘z faoliyatini boshlaydi',
    excerpt:
  ...
  {
    id: 'news-page-03',
    title: 'Talabalar uchun zamonaviy ta’lim muhiti yaratilmoqda',
    excerpt:
    ...
    content: [
      ...
      'XIU zamonaviy fikrlaydigan, tashabbuskor va mehnat bozorida raqobatbardosh yoshlarni tayyorlashni o‘z oldiga maqsad qilib qo‘ygan.',
    ],
  },
  {
    id: 'news-page-04',
    title: 'Malakali mutaxassislarni tayyorlash XIUning asosiy maqsadlaridan biridir',
    excerpt:
    ...
    content: [
      ...
      'Universitet bitiruvchilari nafaqat bilimga ega, balki mustaqil fikrlaydigan, muammolarga yechim topa oladigan va zamonaviy kasbiy talablarga mos mutaxassislar bo‘lib yetishishi ko‘zda tutilgan.',
    ],
  },
]

export const announcementsPageItems = [
  {
    id: 'announcement-page-01',
    title: 'Xorazm Iqtisodiyot Universiteti tez kunda o‘z faoliyatini boshlaydi',
    summary:
      'Xorazm Iqtisodiyot Universiteti iqtisodiyot, biznes, marketing va boshqaruv yo‘nalishlarida zamonaviy ta’lim berishga yo‘naltirilgan yangi oliy ta’lim muassasasi sifatida o‘z faoliyatini boshlashga tayyorgarlik ko‘rmoqda.',
    department: 'Matbuot xizmati',
  ...
  {
    id: 'announcement-page-02',
    title: 'Malakali kadrlarni hamkorlikka taklif qilamiz',
    summary:
    ...
    content: [
      ...
      'Nomzodlardan kasbiy bilim, mas’uliyat, tashabbuskorlik va ta’lim sohasiga qiziqish talab etiladi. Malakali mutaxassislar universitet jamoasiga qo‘shilib, yangi oliy ta’lim muassasasining rivojlanish jarayonida faol ishtirok etishlari mumkin.',
      'Batafsil ma’lumotlar va murojaat tartibi universitetning rasmiy axborot sahifalari orqali e’lon qilinadi.',
    ],
  },
]
